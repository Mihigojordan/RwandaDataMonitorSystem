...
const HeroSection = () => {
  return (
    <section className="relative min-h-[60vh] bg-gradient-to-br from-primary-50 via-white to-primary-50 overflow-hidden">
      ...
      <div className="w-11/12 mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-center w-full gap-12 items-center min-h-[50vh]">
          {/* Left Content */}
          <div className="flex justify-center text-center items-center flex-col gap-10">
            <div className="space-y-6">
              ...
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary-100/50 to-primary-200/50 backdrop-blur-sm border border-primary-300/50 text-primary-600 px-6 py-3 rounded-full text-sm font-medium">
                <Database size={16} className="animate-pulse text-primary-500" />
                Official Statistics 2025
              </div>

              {/* Main Heading */}
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                <span className="bg-gradient-to-r from-primary-600 via-primary-800 to-primary-600 bg-clip-text text-transparent">
                  Access Rwanda’s
                </span>
                <br />
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-3xl">
                Explore reliable and timely statistical data from the National Institute of Statistics of Rwanda to inform policy, research, and development.
              </p>
            </div>
      ...
      <style>{`
        ...
        .bg-grid-pattern {
          background-image: radial-gradient(circle at 1px 1px, rgba(0, 92, 171, 0.1) 1px, transparent 0);
